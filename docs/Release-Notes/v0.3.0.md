...
1. **Actual Stack Deployment**
   - Deploy containers from manifests
   - Docker network creation
   - Container health checks
   - Rollback on failure

2. **Advanced Connection Mode**
   - Per-context connection strings
...
4. **Release Management UI**
   - View available releases
   - Deploy specific versions
   - Rollback to previous versions

5. **Feature Flags UI**
   - Toggle feature flags from dashboard
   - Per-context feature configuration
