...
export default function StopProduct() {
                  ...
                  {stopResults.map((result) => (
                    <div key={result.stackName} className="flex items-center justify-between px-4 py-3 border-b last:border-b-0 border-gray-200 dark:border-gray-700">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">
                        {result.containersStopped} container{result.containersStopped !== 1 ? 's' : ''} stopped
                      </span>
                    </div>
                  ))}
                </div>
  ...
  if (state === 'stopping') {
    return (
      <div className="mx-auto max-w-screen-xl p-4 md:p-6 2xl:p-10">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-white/[0.03]">
          <div className="flex flex-col items-center py-8">
            <div className="w-16 h-16 mb-6 border-4 border-orange-600 border-t-transparent rounded-full animate-spin"></div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
              Stopping Containers...
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
  ...
  return (
    <div className="mx-auto max-w-screen-xl p-4 md:p-6 2xl:p-10">
      ...
      {/* Confirmation Card */}
      <div className="rounded-2xl border border-orange-200 bg-white p-8 dark:border-orange-800 dark:bg-white/[0.03]">
        <div className="flex flex-col items-center py-4">
          {/* Stop Icon */}
          <div className="flex items-center justify-center w-16 h-16 mb-6 bg-orange-100 rounded-full dark:bg-orange-900/30">
                ...
                .map((stack) => (
                  <div key={stack.stackName} className="flex items-center justify-between py-1">
                    <div className="flex items-center gap-2">
                      <svg className="w-3 h-3 text-orange-400" fill="currentColor" viewBox="0 0 8 8">
