...
import { useVersionInfo, useSystemSettingsStore } from '@rsgo/core';
          ...
          {settings.cooldownLoading ? (
            ...
            <div className="space-y-4">
              <div className="flex items-end gap-4">
                <div className="flex-1 max-w-xs">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => settings.setCooldownMinutes(Number(e.target.value))}
                ...
                <button
                  onClick={settings.saveCooldown}
                  disabled={settings.cooldownSaving}
                ...
                >
                  {settings.cooldownSaving ? "Saving..." : "Save"}
                </button>
              </div>

              {settings.cooldownSuccess && (
