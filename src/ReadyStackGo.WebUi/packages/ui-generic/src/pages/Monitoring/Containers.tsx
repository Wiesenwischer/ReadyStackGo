  ...
  const ActionButtons = ({ c, isManaged }: { c: Container; isManaged?: boolean }) => {
    ...
    return (
      <div className="flex items-center gap-1">
        <Link
          to={`/containers/${c.id}/logs?name=${encodeURIComponent(c.name)}`}
          className="p-1.5 rounded text-gray-500 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700"
          title="View Logs"
        >
