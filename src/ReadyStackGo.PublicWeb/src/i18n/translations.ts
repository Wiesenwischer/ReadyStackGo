...
export const translations = {
	de: {
		...
		'features.edgeproxy.title': 'Maintenance Edge-Proxy',
		'features.edgeproxy.desc': 'Überlebender Reverse-Proxy pro Produkt: kontrollierte Wartungsseite statt Connection-Refused — mit maschinenlesbarem Status.',
	...
	en: {
		...
		'features.edgeproxy.title': 'Maintenance Edge-Proxy',
		'features.edgeproxy.desc': 'A surviving per-product reverse-proxy: a controlled maintenance page instead of connection-refused — with a machine-readable status.',
