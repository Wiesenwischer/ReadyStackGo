...
![Deployments overview](/images/docs/product-remove-01-deployments.png)
...
![Product deployment detail with Remove button](/images/docs/product-remove-02-detail.png)
...
![Remove Product confirmation screen](/images/docs/product-remove-03-confirm.png)
...
![Remove Product progress display](/images/docs/product-remove-04-progress.png)
...
![Remove Product result](/images/docs/product-remove-05-success.png)
...
Docker volumes are **not** automatically deleted when a product is removed. Use the [Volume Management](/en/docs/volume-management/) page to clean up orphaned volumes after removal.
:::
