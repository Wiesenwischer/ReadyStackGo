...
/// <summary>
/// Unit tests for Variable domain class.
/// </summary>
public class VariableTests
{
    ...
    {
        // Act
        var variable = new Variable("DB_HOST", "localhost");
    ...
    {
        // Act
        var variable = new Variable("DB_PASSWORD");
    ...
    {
        // Arrange & Act
        var sqlServer = new Variable("SQL_CONN", null, null, VariableType.SqlServerConnectionString);
        var postgres = new Variable("PG_CONN", null, null, VariableType.PostgresConnectionString);
        var mysql = new Variable("MYSQL_CONN", null, null, VariableType.MySqlConnectionString);
        var mongo = new Variable("MONGO_CONN", null, null, VariableType.MongoConnectionString);
        var redis = new Variable("REDIS_CONN", null, null, VariableType.RedisConnectionString);
        var eventStore = new Variable("ES_CONN", null, null, VariableType.EventStoreConnectionString);
    ...
    {
        // Arrange
        var original = new Variable("VAR", "original");
    ...
    {
        // Arrange
        var variable = new Variable("REQUIRED", null, null, VariableType.String, isRequired: true);
